...
INSERT INTO aluno(id_turma,id_endereco_aluno,nome,sobrenome,nascimento,cpf,alergia,genero) VALUES
	...
	((SELECT id FROM turma WHERE serie like '6º ano A'), 7, 'João', 'Carlos', '20000215', 09240329110, NULL, 'M');
...
INSERT INTO contato_aluno(id_aluno,ddd,telefone,email) VALUES
	...
	(3,83,991239520,'elfoladino@hotmail.com'),
	(2,83,997583924,'xitinhas@gmail.com'),
	(6,83,997234923,'candelabrinho@gmail.com');

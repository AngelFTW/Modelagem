...
-- Também devemos setar as constraints, no caso informando se aquela coluna é NOT NULL, PRIMARY KEY, IDENTITY, UNIQUE...
...
-- CRIADAS TODAS AS TABELAS DO DATABASE, PASSAMOS ENTÃO PARA A PARTE DE INSERÇÕES. OU SEJA: IREMOS POPULAR AS TABELAS
...
INSERT INTO turma (serie) VALUES
	...
	('1º ano B ensino medio'),
	('2º ano A ensino medio'),
	('2º ano B ensino medio'),
	('3º ano A ensino medio'),
	('3º ano B ensino medio');
...
INSERT INTO endereco_professor (logradouro,bairro,numero,cep,complemento,cidade,uf) VALUES
	...
	('Rua Roberta Caçarola','Geisel',666,58741529,'Casa','Joao Pessoa','PB'),
...
INSERT INTO aluno(id_turma,id_endereco_aluno,nome,sobrenome,nascimento,cpf,alergia,genero) VALUES
	...
	(2,5,'Fidel','Castro','20000411',01121445698,'crustáceo','M'),
	(2,6,'César','Coelho','20010809',01174445698,'dipirona','M'),
	(2,7,'Mariana','Cunha Lima','20000908',0232445698,'não tem','F'),
	(2,8,'Lucas','Kamion Neiro','20001004',04412445698,'tem,mas não sabe qual é','M'),
...
--COM AS TABELAS JÁ POPULADAS, QUEREMOS ENTÃO RETORNAR AS INFORMAÇÕES INSERIDAS, UTILIZANDO DE SINTAXES QUE IREMOS MOSTRAR ABAIXO:
...
--SELECT UTILIZANDO PARÂMETROS LIKE PARA FILTRAR NOMES CUJA PRIMEIRA LETRA SEJA M, AS LETRAS SUBSEQUENTES NÃO IMPORTAM, E O FINAL TERMINE COM ANA
SELECT nome,sobrenome FROM aluno
...
--VAMOS SUPOR QUE EU QUEIRA MODIFICAR OU ATUALIZAR UM REGISTRO DE UMA TABELA. PODEMOS USAR O COMANDO UPDATE, JUNTAMENTE COM A CLÁUSULA WHERE.
UPDATE aluno 
SET sobrenome = 'Fleumas Mático' 
WHERE id=3;
...
/* CASO EU QUEIRA DELETAR TODOS OS REGISTROS DE UMA TABELA, POSSO USAR O COMANDO TRUNCATE. ELE É MUITO MAIS RÁPIDO QUE EXCLUIR OS REGISTROS UM A UM.
NÃO PODE SER REVERTIDO E OS DADOS NÃO PODEM SER RECUPERADOS. ENTÃO, TOME CUIDADO */
...
--SE DESEJAMOS RETORNAR INFORMAÇÕES SEM VALORES DUPLICADOS, UTILIZAMOS O SELECT DISTINCT.
...
--O left join irá retornar todos os registros da tabela à esquerda, mesmo que não haja nenhum correspondente na tabela à direita
...
--Já o right join,retorna todos os registros da tabela à direita, mesmo que não haja nenhum correspondente na tabela à esquerda.
...
--O full join irá retornar todos os registros das duas tabelas, mesmo que não haja nenhum correspondente na outra tabela.
